...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Already registered Login Here (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Email (4)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Email (5)'), 'test@test.com', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Password (4)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Password (5)'), '123456', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - LOG IN (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Species'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Species (1)'), 'Chromatopelma Cyaneopubescens', 
    0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Name'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Name (1)'), 'Slavica', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - County of origin'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - County of origin (1)'), 'Venezuela', 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.RadioButton - 1 (1)'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Log out (1)'), 0)
